...
// import 'package:hello_app/database.dart';
...
class ReadGeoData extends StatefulWidget {
  const ReadGeoData({super.key});

  @override
  State<ReadGeoData> createState() => _ReadGeoDataState();
}

class _ReadGeoDataState extends State<ReadGeoData> {
  TextEditingController textController = TextEditingController();
  String defaultCity = ''; // Initialize defaultCity here

  @override
  void initState() {
    super.initState();

    // Retrieve the user's default city from Firebase
      ...
      FirebaseFirestore.instance
        ...
        if (doc.exists) {
          final data = doc.data() as Map<String,
              dynamic>?; // Explicitly cast data to the expected type
          if (data != null) {
            setState(() {
              defaultCity = data['defaultCity'] ?? '';
              textController.text = defaultCity;
            });
          }
        }
  ...
  // Function to update the default city in Firebase
