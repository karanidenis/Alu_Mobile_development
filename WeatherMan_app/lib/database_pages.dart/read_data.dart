...
// Apply CRUD operations to location collection
...
class _ReadGeoDataState extends State<ReadGeoData> {
  String? location, timezone, country;

  TextEditingController textcontroller = TextEditingController();

  searchUser(String location) async {
    QuerySnapshot querySnapshot =
        await DataGeoMethods().getthisUserInfo(location);

    country = querySnapshot.docs[0].id;
      ...
      body: Container(
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () async {
                await DataGeoMethods().UpdateUserData("WAT", country!);
                searchUser(textcontroller.text);
              },
              child: Center(
                child: Container(
            ...
            GestureDetector(
              onTap: () async {
                ...
                await DataGeoMethods().DeleteUserData(location!);
